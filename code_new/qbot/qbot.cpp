...
void MiniKame::walk(float steps=1, float T=550){
    int x_amp = 25;
    int z_amp = 25;
    int ap = 20;
    int hi = 10;
...
void MiniKame::home(){
    int hip_offset = 0;
    int knee_offset = 90;
    int position[] = {90+hip_offset,90-hip_offset,90+knee_offset,90-knee_offset,90-hip_offset,90+hip_offset,90-knee_offset,90+knee_offset};
